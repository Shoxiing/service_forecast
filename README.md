...
## Структура проекта
- В корне проекта содержится docker файл docker-compose.yaml для развертывания проекта целиком ( Airflow, БД к ней и БД для проекта, и сам tg_bot)
...
### Алгоритм запуска веб-сервиса по прогнозу цены BTC
